...
export const metadata = {
  ...
  description: 'A warm restaurant for seasonal dining, table reservations, and private room bookings.',
}
      ...
      <body className="flex min-h-screen flex-col antialiased">
        ...
        <footer className="border-t border-stone-200 bg-white px-4 py-14 text-stone-700 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
            <div>
              <Link href="/" className="text-2xl font-semibold text-stone-950">Palma</Link>
              <p className="mt-4 max-w-md leading-7 text-stone-600">
                Seasonal plates, calm rooms, and thoughtful hospitality for dinner, private gatherings, and the nights you want to remember.
              </p>
            </div>
            <div>
              <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-stone-950">Visit</h2>
              <div className="mt-5 space-y-3 text-sm">
                <p className="flex items-center gap-3"><MapPin className="h-4 w-4 text-emerald-800" />123 Restaurant St, City Center</p>
                <p className="flex items-center gap-3"><Phone className="h-4 w-4 text-emerald-800" />(123) 456-7890</p>
                <p className="flex items-center gap-3"><Mail className="h-4 w-4 text-emerald-800" />info@palma.com</p>
              </div>
            </div>
            <div>
          ...
          <div className="mx-auto mt-10 flex max-w-7xl flex-col gap-3 border-t border-stone-200 pt-6 text-sm text-stone-500 sm:flex-row sm:items-center sm:justify-between">
            <p>&copy; 2026 Palma Restaurant. All rights reserved.</p>
